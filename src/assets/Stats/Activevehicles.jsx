...
const Activevehicles = () => {
  ...
  useEffect(() => {
    const f = () => fetch(`${(import.meta.env.VITE_API_BASE_URL || (import.meta.env.DEV ? "http://127.0.0.1:8000" : "https://swiftrescue-backend-shlb.onrender.com")).replace(/\/+$/, "")}/api/ambulances/`)
      .then(r => r.json())
