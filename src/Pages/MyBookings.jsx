    ...
    <>
      <style>{`
        ...
        .mb-stat  {
          ...
          position:relative;
          overflow:hidden;
          box-shadow:0 8px 22px rgba(214,232,0,0.16);
          transition:border-color 0.2s ease, box-shadow 0.2s ease, transform 0.2s ease;
        }
        .mb-stat:hover {
          border-color:rgba(214,232,0,0.95);
          box-shadow:0 14px 30px rgba(214,232,0,0.3);
        ...
        .mb-filter-btn.active { background:#d6e800; color:#111; border-color:#d6e800; box-shadow:0 4px 16px rgba(214,232,0,0.35); }
        ...
        .mb-card {
          background:#ffffff;
          border:1px solid rgba(214,232,0,0.56);
          border-radius:20px;
          overflow:hidden;
          transition:transform 0.2s ease, box-shadow 0.2s ease, border-color 0.2s ease;
          width:100%;
          box-shadow:0 12px 30px rgba(214,232,0,0.16);
        }
        .mb-card:hover {
          transform:translateY(-2px);
          border-color:rgba(214,232,0,0.95);
          box-shadow:0 18px 36px rgba(214,232,0,0.28);
        }
        ...
        .mb-amb-strip  { background:rgba(214,232,0,0.12); border:1px solid rgba(20,20,20,0.12); border-radius:14px; padding:14px 16px; display:flex; align-items:center; gap:14px; margin-bottom:18px; }
        ...
        .mb-card-footer { padding:14px 20px; background:rgba(214,232,0,0.08); border-top:1px solid rgba(20,20,20,0.08); }
        .mb-track-btn { width:100%; display:flex; align-items:center; justify-content:center; gap:8px; background:#d6e800; color:#111; border:none; border-radius:14px; padding:13px 0; font-size:14px; font-weight:800; font-family:inherit; cursor:pointer; transition:background 0.15s, transform 0.15s; box-shadow:0 4px 20px rgba(214,232,0,0.35); }
        .mb-track-btn:hover { background:#c5d700; transform:translateY(-1px); }
        .mb-track-btn .live-badge { background:#111; color:#d6e800; font-size:9px; font-weight:900; padding:2px 8px; border-radius:100px; }
        .mb-delete-btn {
          width: 100%;
          border: 1px solid rgba(214,232,0,0.82);
          border-radius: 14px;
          background: #fffef2;
          color: #111;
          padding: 12px 0;
        ...
        .mb-delete-btn:hover {
          border-color: rgba(214,232,0,1);
          box-shadow: 0 10px 20px rgba(214,232,0,0.28);
        ...
        .mb-track-chip {
          ...
          cursor: pointer;
          box-shadow: 0 8px 16px rgba(214,232,0,0.35);
          transition: transform 0.15s ease, box-shadow 0.15s ease;
        }
        .mb-track-chip:hover {
          transform: translateY(-1px);
          box-shadow: 0 10px 18px rgba(214,232,0,0.45);
        }
      ...
      <div className="page-root" ref={rootRef}>
        <div className="page-content" style={{ maxWidth: "1520px", width: "100%" }}>
          ...
          <div className="page-section-header mb-reveal-top">
            <div style={{ display:"inline-flex", alignItems:"center", gap:6, fontSize:10, fontWeight:700, color:"#111", background:"rgba(214,232,0,0.2)", border:"1px solid rgba(20,20,20,0.14)", borderRadius:100, padding:"4px 14px", letterSpacing:1, textTransform:"uppercase", marginBottom:12 }}>
              🚑 My Bookings
            </div>
          ...
          {loading && (
            <div style={{ display:"flex", flexDirection:"column", alignItems:"center", padding:"64px 0", gap:12 }}>
              <div style={{ width:36, height:36, border:"3px solid rgba(20,20,20,0.1)", borderTop:"3px solid #d6e800", borderRadius:"50%", animation:"mb-spin 0.8s linear infinite" }}/>
                    ...
                    <div className="mb-card-body">
                      {(b.ambulance_number||b.ambulance_id) && (
                        <div className="mb-amb-strip">
                          <div style={{ width:38, height:38, borderRadius:"50%", background:"rgba(214,232,0,0.2)", display:"flex", alignItems:"center", justifyContent:"center", flexShrink:0 }}>
                            <Icons.Ambulance/>
                          </div>
                          <div>
                      ...
                      <div className="mb-detail-grid">
                        <DetailItem icon={<Icons.MapPin/>} iconColor="#8c9600"               label="Pickup Location" value={b.pickup_location}/>
                        ...
                        <DetailItem icon={<Icons.Clock/>}  iconColor="#8c9600" label="Response Note" value={b.hospital_response_note || "-"} />
