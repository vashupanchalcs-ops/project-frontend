...
const statusColors = {
  pending: { color: "#111", bg: "#d6e800", border: "#c7d800" },
  confirmed: { color: "#111", bg: "#d6e800", border: "#c7d800" },
  completed: { color: "#111", bg: "#d6e800", border: "#c7d800" },
  cancelled: { color: "#111", bg: "#d6e800", border: "#c7d800" },
};
  ...
  return (
    <>
      <style>{`
        .req-root {
          background:
            radial-gradient(920px 430px at 88% 8%, rgba(214,232,0,0.18), transparent 72%),
        ...
        .req-tag {
          ...
          font-weight: 700;
          color: #111;
          background: rgba(214,232,0,0.82);
        ...
        .req-card-item:hover {
          border-color: rgba(214,232,0,0.9);
          box-shadow: 0 14px 30px rgba(214,232,0,0.2);
        ...
        .req-empty {
          ...
          font-size: 14px;
          border: 1px dashed rgba(214,232,0,0.8);
          border-radius: 14px;
