  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f6f8ef", padding: isMobile ? "84px 16px 90px 16px" : "84px 18px 30px 78px", fontFamily: "'Helvetica Neue', Arial, sans-serif", overflowX: "hidden" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <section style={{ border: "1px solid rgba(17,17,17,0.14)", borderRadius: 18, padding: 18, background: "#fff" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10, flexWrap: "wrap" }}>
            ...
            <button
              ...
              style={{ border: "1px solid rgba(17,17,17,0.2)", borderRadius: 12, background: "#ffffff", padding: "10px 14px", fontWeight: 800, cursor: "pointer" }}
            >
        ...
        {msg && (
          <div style={{ marginTop: 10, border: "1px solid rgba(156,171,0,0.5)", borderRadius: 12, background: "rgba(255, 255, 255, 0.15)", padding: 10, fontSize: 13, fontWeight: 700 }}>
            {msg}
          </div>
        )}
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10, flexWrap: "wrap", marginBottom: 10 }}>
                    ...
                    <div style={{ display: "inline-flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
                      ...
                      <span style={{ border: "1px solid rgba(156,171,0,0.6)", background: "rgba(255, 255, 255, 0.15)", borderRadius: 999, padding: "6px 10px", fontWeight: 800, fontSize: 12 }}>
