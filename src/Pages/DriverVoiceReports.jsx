...
export default function DriverVoiceReports() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f6f6f0", padding: isMobile ? "84px 16px 90px 16px" : "84px 16px 30px 80px", fontFamily: "'Helvetica Neue', Arial, sans-serif", overflowX: "hidden" }}>
      <div style={{ maxWidth: 1340, margin: "0 auto" }}>
        <div style={{ border: "1px solid rgba(17,17,17,0.14)", borderRadius: 16, background: "#fff", padding: 18, marginBottom: 14, display: "flex", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <button
              onClick={connectMic}
              style={{ border: "1px solid rgba(17,17,17,0.2)", borderRadius: 12, padding: "10px 14px", fontWeight: 800, background: micConnected ? "#d6e800" : "#fff", cursor: "pointer" }}
            >
        ...
        {bookings.length === 0 && (
          <div style={{ border: "1px dashed rgba(17,17,17,0.25)", borderRadius: 14, padding: 24, textAlign: "center", color: "rgba(17,17,17,0.65)", background: "rgba(214,232,0,0.1)" }}>
              ...
              <article key={bid} style={{ border: "1px solid rgba(156,171,0,0.45)", borderRadius: 16, background: "#fffef7", padding: 14, boxShadow: "0 10px 20px rgba(0,0,0,0.04)" }}>
                <div style={{ display: "flex", justifyContent: "space-between", gap: 8, marginBottom: 10 }}>
                  ...
                  <div style={{ display: "flex", alignItems: "start", gap: 8, position: "relative" }}>
                    <span style={{ alignSelf: "start", border: "1px solid rgba(17,17,17,0.2)", borderRadius: 999, padding: "5px 10px", fontSize: 11, fontWeight: 700, textTransform: "uppercase", background: "#d6e800" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 8 }}>
                  <button
                    ...
                    style={{ border: "1px solid #111", borderRadius: 10, padding: "9px 10px", cursor: "pointer", fontWeight: 800, background: isRecording ? "#111" : "#d6e800", color: isRecording ? "#fff" : "#111" }}
                  >
                ...
                <div style={{ marginTop: 10, display: "flex", justifyContent: "space-between", alignItems: "center", gap: 8 }}>
                  ...
                  {isSent ? (
                    ...
                    <button
                      ...
                      style={{ border: "1px solid #111", borderRadius: 10, padding: "10px 14px", cursor: savingBookingId === bid || !aiDraft ? "default" : "pointer", fontWeight: 800, background: !aiDraft ? "#f3f3e8" : "#d6e800", color: "#111" }}
                    >
