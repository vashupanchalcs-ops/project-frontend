...
class BookingChatThreadInline(admin.StackedInline):
    """Expose the related support conversation from its dispatch record."""
...
class BookingChatMessageInline(admin.TabularInline):
    """Keep the full message timeline visible while reviewing a chat thread."""
