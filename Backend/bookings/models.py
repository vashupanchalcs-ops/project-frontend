...
class BookingChatThread(models.Model):
    ...
    admin_email = models.CharField(max_length=120, blank=True, default="vashupanchal.cs@gmail.com")
    is_active = models.BooleanField(default=True)

    # Presence + typing state for live UX
    ...
    def __str__(self):
        return f"ChatThread #{self.id} • Booking #{self.booking_id}"
...
class BookingChatMessage(models.Model):
    ...
    def __str__(self):
        return f"ChatMsg #{self.id} ({self.sender_role})"
