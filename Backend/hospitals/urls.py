...
urlpatterns = [
    ...
    path("<str:id>/dashboard/",           views.hospital_dashboard),
    path("<str:id>/resources/",           views.hospital_resources),
    ...
    path("<int:hospital_id>/staff-team/assign/", views.assign_staff_team),
