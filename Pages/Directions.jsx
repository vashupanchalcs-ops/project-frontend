  ...
  return (
    <>
      <style>{`
        ...
        .dir-title { font-size:17px;font-weight:800;color:#0a0a0a;letter-spacing:-.4px; }
        .dir-subtitle { font-size:11px;color:#6e6e73; }
        ...
        .dir-live { display:inline-flex;align-items:center;gap:6px;background:rgba(229,9,20,0.07);border:1px solid rgba(229,9,20,0.2);border-radius:100px;padding:5px 13px;font-size:11px;font-weight:700;color:#E50914; }
        .dir-live-dot { width:6px;height:6px;border-radius:50%;background:#E50914;animation:dir-blink 1.6s infinite; }
        .dir-clock { font-size:12px;font-weight:700;color:#6e6e73; }
        .dir-back { display:inline-flex;align-items:center;gap:5px;font-size:12px;font-weight:700;color:#0a0a0a;background:#f0f0f2;border:1.5px solid rgba(0,0,0,0.1);border-radius:9px;padding:7px 14px;cursor:pointer;font-family:inherit;transition:all .15s; }
        .dir-back:hover { background:#e8e8eb; }
        ...
        .dir-drv-av { width:34px;height:34px;border-radius:9px;background:#E50914;display:flex;align-items:center;justify-content:center;font-size:15px;font-weight:800;color:#fff;flex-shrink:0; }
        .dir-drv-name { font-size:13px;font-weight:800;color:#0a0a0a; }
        .dir-drv-meta { font-size:10px;color:#6e6e73;margin-top:1px; }
        .dir-call-btn { display:inline-flex;align-items:center;gap:6px;background:#0a0a0a;color:#fff;border:none;border-radius:8px;padding:7px 15px;font-size:11px;font-weight:700;font-family:inherit;text-decoration:none;cursor:pointer;transition:background .15s;margin-left:auto;flex-shrink:0; }
        .dir-call-btn:hover { background:#222; }
        ...
        .dir-chip { display:flex;flex-direction:column;gap:1px;padding:8px 18px;border-right:1px solid rgba(0,0,0,0.06);flex-shrink:0; }
        .dir-chip:last-child { border-right:none; }
        .dir-chip-lbl { font-size:8px;font-weight:800;color:#a1a1a6;text-transform:uppercase;letter-spacing:1px; }
        .dir-chip-val { font-size:12px;font-weight:700;color:#0a0a0a; }
        .dir-chip-val.eta { color:#E50914; }

        /* Route status bar */
        .dir-status-bar {
          display: flex; align-items: center; gap: 8px;
          padding: 7px 20px; background: #f8f8fa;
          border-bottom: 1px solid rgba(0,0,0,0.06);
          font-size: 11px; font-weight: 600; color: #3d3d3d;
          flex-shrink: 0;
        }
        ...
        @media(max-width:600px) {
          ...
          .dir-legend { bottom:14px;left:10px;min-width:130px; }
